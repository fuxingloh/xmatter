---
name: Roundhill Memory ETF Tokenized bStocks
...
links:
  ...
  - name: coinmarketcap
    url: >-
      https://coinmarketcap.com/currencies/roundhill-memory-etf-tokenized-bstocks/
symbol: DRAMB
decimals: 18
icons:
  - icon.png
