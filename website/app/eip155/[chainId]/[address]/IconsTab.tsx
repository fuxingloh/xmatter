    ...
    return (
      <svg viewBox="0 0 20 16" height="16" width="16" className="opacity-80">
        <path
          ...
          clipRule="evenodd"
          strokeLinejoin="round"
          d="M2.5 2.25H17.5C18.1904 2.25 18.75 2.80964 18.75 3.5V12.5C18.75 13.1904 18.1904 13.75 17.5 13.75H2.5C1.80964 13.75 1.25 13.1904 1.25 12.5V3.5C1.25 2.80964 1.80964 2.25 2.5 2.25ZM0 3.5C0 2.11929 1.11929 1 2.5 1H17.5C18.8807 1 20 2.11929 20 3.5V12.5C20 13.8807 18.8807 15 17.5 15H2.5C1.11929 15 0 13.8807 0 12.5V3.5ZM4.25 9V11H2.75V9V8.25V5.75V5H3.5H4.25H5C5.9665 5 6.75 5.7835 6.75 6.75V7.25C6.75 8.2165 5.9665 9 5 9H4.25ZM4.25 7.5H5C5.1381 7.5 5.25 7.38807 5.25 7.25V6.75C5.25 6.61193 5.1381 6.5 5 6.5H4.25V7.5ZM7.75 5H9.25L10.25 8.5V5H11.75V11H10.25L9.25 7.5V11H7.75V5ZM14.75 5C13.5074 5 12.5 6.00736 12.5 7.25V8.75C12.5 9.99264 13.5074 11 14.75 11H16C16.6904 11 17.25 10.4404 17.25 9.75V9.25C17.25 8.55964 16.6904 8 16 8H15.25V9.5H14.75C14.3358 9.5 14 9.16421 14 8.75V7.25C14 6.83579 14.3358 6.5 14.75 6.5H15.25C15.5261 6.5 15.75 6.72386 15.75 7H17.25C17.25 5.89543 16.3546 5 15.25 5H14.75Z"
          fill="currentColor"
        />
      </svg>
    );
