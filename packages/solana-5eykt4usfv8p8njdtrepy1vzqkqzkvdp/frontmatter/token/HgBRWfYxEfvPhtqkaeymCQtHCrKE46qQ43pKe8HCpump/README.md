...
links:
  - name: website
    url: https://bert.global/
  - name: explorer
    url: https://solscan.io/token/HgBRWfYxEfvPhtqkaeymCQtHCrKE46qQ43pKe8HCpump
  - name: x
    url: https://x.com/bertcoincto
  - name: telegram
    url: https://t.me/bertsolanaportal
  - name: discord
    url: https://discord.com/invite/bertnft
  - name: coingecko
    url: https://coingecko.com/en/coins/bertram-the-pomeranian
  - name: coinmarketcap
